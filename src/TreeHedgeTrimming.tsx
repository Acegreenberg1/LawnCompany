...
const faqs = [
  ...
  },
  {
    ...
    a: 'The terms are often used interchangeably, but in professional arboriculture there is a distinction. Trimming typically refers to cutting back growth for aesthetic purposes, such as shaping a hedge, maintaining clearance, or keeping a tree within a desired size. Pruning refers specifically to cuts made for the health and structural benefit of the plant, removing dead, diseased, or crossing branches, improving light penetration, or correcting poor branching structure. Most jobs involve elements of both. We approach every tree and hedge job with both goals in mind: the plant should look better and be healthier after we leave.',
  },
  {
